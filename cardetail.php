...
<div class="container mt-5">
    ...
    <div class="car-container">
        ...
        if(isset($_GET['kmRange']) && $_GET['kmRange'] !== ''){
            $kmRange = intval($_GET['kmRange']);
            $sql .= " WHERE KM < $kmRange";
        }
        if(isset($_GET['priceRange']) && $_GET['priceRange'] !== ''){
            $priceRange = intval($_GET['priceRange']);
            $sql .= isset($_GET['kmRange']) && $_GET['kmRange'] !== '' ? " AND Price < $priceRange" : " WHERE Price < $priceRange";
        }
        if(isset($_GET['modelFilter']) && $_GET['modelFilter'] !== ''){
            $modelFilter = $conn->real_escape_string($_GET['modelFilter']);
            $sql .= isset($_GET['kmRange']) && $_GET['kmRange'] !== '' || isset($_GET['priceRange']) && $_GET['priceRange'] !== '' ? " AND Model = '$modelFilter'" : " WHERE Model = '$modelFilter'";
        }
